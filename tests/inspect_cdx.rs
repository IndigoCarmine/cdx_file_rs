...
fn count_objects(node: dendron::Node<cdx_file_rs::cdx::file::NodePayload>, depth: usize) {
    ...
    match &*data {
        cdx_file_rs::cdx::file::NodePayload::Document(d) => {
        ...
        cdx_file_rs::cdx::file::NodePayload::Fragment(f) => {
            println!("{}Fragment (id={})", indent, f.id)
        }
        cdx_file_rs::cdx::file::NodePayload::TextObject(t) => {
            println!("{}Text (id={})", indent, t.id)
        }
