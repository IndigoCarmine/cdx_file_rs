...
pub const CDXPROP_CAPTION_STYLE_FONT: u16 = 0x081B;
pub const CDXPROP_LABEL_STYLE_SIZE: u16 = 0x081C;
pub const CDXPROP_CAPTION_STYLE_SIZE: u16 = 0x081D;
pub const CDXPROP_LABEL_STYLE_FACE: u16 = 0x081E;
pub const CDXPROP_CAPTION_STYLE_FACE: u16 = 0x081F;
pub const CDXPROP_LABEL_STYLE_COLOR: u16 = 0x0820;
pub const CDXPROP_CAPTION_STYLE_COLOR: u16 = 0x0821;
