CDX Format Specification: CDX Color Table Data Type
## CDX Color Table Data Type

**In CDX files**, this data type consists of a series of a [UINT16](CDXNumeric.md) count, followed by that many [UINT16](CDXNumeric.md) triples. Each of those triples consists of the red, green, and blue components (in that order) of the color value, scaled to a range of 0...65535
