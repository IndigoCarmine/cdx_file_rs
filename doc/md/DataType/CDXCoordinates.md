CDX Format Specification: CDX Coordinates Data Types
...
**In CDX files**, a CDXPoin t2D is an x- and a y-CDXCoordinate stored as a pair of [INT32](CDXNumeric.md)s, y coordinate followed by x coordinate. 

**In CDXML files**, a CDXPoint2D is a stored as a pair of numeric values, x coordinate followed by y coordinate. Note that this ordering is different than in CDX files!
...
**In CDXML files**, a CDXPoint2D is a stored as a pair of numeric values, x coordinate followed by y coordinate followed by z coordinate. Note that this ordering is different than in CDX files!
