...
When used as a property of a document, this property is meaningful only for documents with a [DrawingSpaceType](DrawingSpaceType.md) of type Poster. This value overrides the default document width and will be used as specified in the [kCDXProp_MacPrintInfo](MacPrintInfo.md) property.
