CDX Format Specification: Graphic_Type Property
...
| 2 | Arc | Arc ([kCDXProp_Line_Type](Line_Type.md)should be present.[kCDXProp_Arc_AngularSize](Arc_AngularSize.md)should be present.[kCDXProp_Arrow_Type](Arrow_Type.md)may also be present.) The two points stored within the[kCDXProp_BoundingBox](BoundingBox.md)represent the center and end of he arc. |
