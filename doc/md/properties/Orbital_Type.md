CDX Format Specification: Orbital_Type Property
...
| --- | --- | --- |
| 0 | s | s orbital |
| 1 | oval | Oval-shapedsorporbital |
| 2 | lobe | One lobe of a p orbital |
| 3 | p | Complete p orbital |
| 4 | hybridPlus | hydrid orbital |
| 5 | hybridMinus | hydrid orbital (opposite shading) |
| 6 | dz2Plus | dz2orbital |
| 7 | dz2Minus | dz2orbital (opposite shading) |
| 8 | dxy | dxyorbital |
| 256 | sShaded | shaded s orbital |
| 257 | ovalShaded | shaded oval-shapedsorporbital |
| 258 | lobeShaded | shaded single lobe of a p orbital |
| 259 | pShaded | shaded complete p orbital |
| 512 | sFilled | filled s orbital |
| 513 | ovalFilled | filled oval-shapedsorporbital |
| 514 | lobeFilled | filled single lobe of a p orbital |
| 515 | pFilled | filled complete p orbital |
| 516 | hybridPlusFilled | filled hydrid orbital |
| 517 | hybridMinusFilled | filled hydrid orbital (opposite shading) |
| 518 | dz2PlusFilled | filled dz2orbital |
| 519 | dz2MinusFilled | filled dz2orbital (opposite shading) |
| 520 | dxyFilled | filled dxyorbital |
