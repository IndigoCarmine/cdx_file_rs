...
| 2 | Transmittance | Axis is in transmittance units. The baseline is at 1.0 and peaks point down to a value of 0.0 being no transmission. Only for IR spectra |
| 3 | PercentTransmittance | Axis is in transmittance units\*100. The baseline is at 100% and peaks point down to a value of 0.0 being no transmission. Only for IR spectra |
