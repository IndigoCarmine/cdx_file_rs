CDX Format Specification: GeometricFeature Property
...
| 5 | PlaneFromPoints | A best fit plane defined by three or more points.[kCDXProp_BasisObjects](BasisObjects.md)should be present and contain an unordered list consisting of at least three points. If more than three points are used to define this line, a[maximum RMS deviation](RelationValue.md)may also be specified |
| 6 | PlaneFromPointLine | A plane defined by a point and a line.[kCDXProp_BasisObjects](BasisObjects.md)should be present and contain an unordered list consisting of at a point and a line. |
...
| 8 | NormalFromPointPlane | A normal line defined by a point and a plane.[kCDXProp_BasisObjects](BasisObjects.md)should be present and contain an unordered list consisting of at a point and a plane. |
