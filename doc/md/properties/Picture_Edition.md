...
It exists only on the Macintosh platform. Apple Computer, Inc. has removed support of Publish and Subscribe from recent versions of MacOS. This property will only be written or read in ChemDraw 6.0 and earlier.
