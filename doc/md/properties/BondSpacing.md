...
Note that this property (in combination with [kCDXProp_BondLength](BondLength.md)) is redundant with [kCDXProp_BondSpacingAbs](BondSpacingAbs.md). Only one of the two need be present. If both are present and contradictory, ChemDraw gives preference to the BondSpacingAbs value.
